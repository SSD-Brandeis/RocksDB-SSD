...
static std::unordered_map<std::string, OptionTypeInfo>
    stateful_vector_rep_table_info = {
        {"count",
         {0, OptionType::kSizeT, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
};

StatefulVectorRepFactory::StatefulVectorRepFactory(size_t count)
    : count_(count) {
  RegisterOptions("StatefulVectorRepFactoryOptions", &count_,
                  &stateful_vector_rep_table_info);
}

MemTableRep* StatefulVectorRepFactory::CreateMemTableRep(
